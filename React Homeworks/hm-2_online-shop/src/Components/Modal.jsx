                        ...
                        <div className="modal-pop-up">
                            <div className="modal-content">
                                ...
                                <div className="modal-footer">
                                    <Button classList="btn" backgroundColor="#6c757d" text={this.props.btnText.back} onClick={this.setActive} />
                                    <Button classList="btn" backgroundColor="#28a745" text={this.props.btnText.add} onClick={this.setActive} />
                                </div>
                            </div>
                        </div>
                    </div>
